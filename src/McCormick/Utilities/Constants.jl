...
const IntervalType = IntervalArithmetic.Interval{Float64}
const IntervalConstr = IntervalArithmetic.interval
const Half64 = Float64(0.5)
const Two64 = Float64(2.0)
const Three64 = Float64(3.0)
const EqualityTolerance = Float64(1E-12)
const DegToRadIntv = IntervalArithmetic.pi_interval(Float64)/Interval(180.0)
